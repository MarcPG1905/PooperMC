...
import com.marcpg.poopermc.storage.RamStorage;
import com.marcpg.poopermc.storage.Storage;
import com.marcpg.poopermc.storage.YamlStorage;
...
public final class FriendSystem {
    ...
    public static @NotNull BrigadierCommand command() {
        if (STORAGE == null)
            STORAGE = Storage.storageType.createStorage("friendships", "uuid");
                        ...
                        .then(RequiredArgumentBuilder.<CommandSource, String>argument("player", StringArgumentType.word())
                                ...
                                .executes(context -> {
                                    ...
                                    if (getFriendship(playerUuid, targetUuid) != null) {
                                        ...
                                        VelocityPooper.SERVER.getPlayer(targetUuid).ifPresent(t -> {

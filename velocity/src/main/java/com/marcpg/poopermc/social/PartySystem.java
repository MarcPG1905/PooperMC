package com.marcpg.poopermc.social;
                ...
                .then(LiteralArgumentBuilder.<CommandSource>literal("invite")
                        .then(RequiredArgumentBuilder.<CommandSource, String>argument("player", StringArgumentType.word())
                                ...
                                .executes(context -> {
                                    ...
                                    VelocityPooper.SERVER.getPlayer(targetUuid).ifPresentOrElse(
                                            target -> {
                ...
                .then(LiteralArgumentBuilder.<CommandSource>literal("accept")
                        .then(RequiredArgumentBuilder.<CommandSource, String>argument("player", StringArgumentType.word())
                                ...
                                .executes(context -> {
                                    ...
                                    VelocityPooper.SERVER.getPlayer(targetUuid).ifPresentOrElse(
                                            target -> {
                                                PARTIES.get(PLAYER_PARTIES.get(targetUuid)).keySet().forEach(uuid -> VelocityPooper.SERVER.getPlayer(uuid).ifPresent(
                ...
                .then(LiteralArgumentBuilder.<CommandSource>literal("deny")
                        .then(RequiredArgumentBuilder.<CommandSource, String>argument("player", StringArgumentType.word())
                                ...
                                .executes(context -> {
                                    ...
                                    VelocityPooper.SERVER.getPlayer(targetUuid).ifPresent(target -> target.sendMessage(Translation.component(target.getEffectiveLocale(), "party.deny.msg", player.getUsername()).color(RED)));
                        ...
                        .executes(context -> {
                            ...
                            if (PLAYER_PARTIES.containsKey(playerUuid)) {
                                ...
                                if (party.get(playerUuid)) {
                                    ...
                                    PARTIES.get(PLAYER_PARTIES.get(playerUuid)).keySet().forEach(uuid -> VelocityPooper.SERVER.getPlayer(uuid).ifPresent(
                                ...
                                .suggests((context, builder) -> {
                                    ...
                                    if (PLAYER_PARTIES.containsKey(playerUuid)) {
                                        PARTIES.get(PLAYER_PARTIES.get(playerUuid)).entrySet().stream()
                                                ...
                                                .forEach(e -> VelocityPooper.SERVER.getPlayer(e.getKey()).ifPresent(p -> builder.suggest(p.getUsername())));
                                    }
                                    return builder.buildFuture();
                                })
                                .executes(context -> {
                                ...
                                .executes(context -> {
                                    ...
                                    if (PLAYER_PARTIES.containsKey(playerUuid)) {
                                        ...
                                        for (UUID uuid : PARTIES.get(PLAYER_PARTIES.get(playerUuid)).keySet()) {
                                            VelocityPooper.SERVER.getPlayer(uuid).ifPresent(t ->
